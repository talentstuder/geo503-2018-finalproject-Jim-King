...
Actually the background is easier to write than the code part, my suggestion is that it's necessary to use some words to describe why you conduct this research, the meaning of it and your expect result. Every research should have a proposal first, that's the main difference from a lab report.
...
```
These codes are excellent, they gave very clear instruction on how to create the material map. However, it may be necessary to arrange these materials and reduce length because the procedure of creating research data is just one part of the whole research, it's better to give some explanations on the statistic results and the analysis progress.
